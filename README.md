**Note:** This repository contains the application source code, Docker containerization, and CI/CD pipeline responsible for building the container image and deploying it to Azure Container Registry (ACR).  
The Azure infrastructure (VNet, AKS, ACR, storage, and related resources) is managed separately using Terraform.  
For the infrastructure repository, please visit: **[Infrastructure Repository](https://github.com/birrkan/azure-aks-terraform-nginx-INFRA-REPO)**
